...
DECLARE  
	...
	y Osrodki.id_osrodek%TYPE; -- numer orodka  
...
BEGIN  
	...
	TabPrz(5).Nazwa_Przedmiot:='Zarz¹dzanie projektem informatycznym';  
	TabPrz(6).Id_Przedmiot:=6;  
	TabPrz(6).Nazwa_Przedmiot:='Jêzyki baz danych';  
	...
	TabPrz(13).Nazwa_Przedmiot:='In¿ynieria oprogramowania';  
	...
	TabSt(16).nazwisko := 'M¹czka';  
	TabSt(16).imie := 'Jan';  
	TabSt(17).id_student :='0000017';  
	TabSt(17).nazwisko := 'Mêdrzak';  
	...
	TabWyk(3).imie := 'Czes³aw';  
	TabWyk(4).id_egzaminator := '0004';  
	TabWyk(4).nazwisko := 'Opa³';  
